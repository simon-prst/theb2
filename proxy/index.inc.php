...
<div id="container">
  <h1 id="title">B2Proxy</h1>
  <h3 id="title">Un moyen simple pour contourner les blocages de sites ;-)</h3>
<?php
...
?>
  <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
    <ul id="form">
      <li id="address_bar"><label>Adresse URL <input id="address_box" type="text" name="<?php echo $GLOBALS['_config']['url_var_name'] ?>" value="<?php echo isset($GLOBALS['_url']) ? htmlspecialchars($GLOBALS['_url']) : '' ?>" onfocus="this.select()" /></label> <input id="go" type="submit" value="Go !" /></li>
      <?php
  ...
  <br /><div id="footer"><a href="http://sourceforge.net/projects/poxy/">PHProxy</a> <?php echo $GLOBALS['_version'] ?> mod <a href="http://www.sebsauvage.net">SSE</a>+ARKA 20100825 | <a href="LICENSE.txt">Licence GNU GPLv2</a></div>
</div>
</body>
</html>